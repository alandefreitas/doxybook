...
Classes # Classes Description AudioBuffer A simple audio buffer to hold PCM samples (class) AudioManager An audio manager that accepts multiple Audio::AudioBuffer instances. (class) Updated on 2023-01-01
...
This has some weird bug too! Updated on 2023-01-01
`}),e.add({id:5,href:"/doxybook/hugo-book/classes/",title:"Classes",section:"Doxybook Example",content:` Classes # Class Engine This namespace contains all of the necessary engine components. (namespace) Assets (namespace) Asset (class) Event (union) Loaded (struct) Unloaded (struct) Waiting (struct) Audio (namespace) AudioBuffer A simple audio buffer to hold PCM samples(class) TypedAudioData Use this to populate the buffer. (struct) AudioManager An audio manager that accepts multiple Audio::AudioBuffer instances. (class) Exception (class) Graphics (namespace) Framebuffer (class) Handle (class) Texture This is a base texture class that serves as a base class for other texture types. (interface) Texture2D (class) Texture3D Some deprecated class. (class) Gui (namespace) GuiWidget Some generic gui widget class. (class) Utils (namespace) ArrayView Filesystem path utility functions. (class) Path Filesystem path utility functions. (namespace) std (namespace) Updated on 2023-01-01
...
Don\u0026rsquo;t use this texture type Updated on 2023-01-01
...
Basic exception guarantee.
Updated on 2023-01-01
`}),e.add({id:8,href:"/doxybook/hugo-book/namespaces/namespaceengine_1_1assets/",title:"Engine::Assets",section:"Namespaces",content:` Engine::Assets # Classes # Classes Description Asset Engine::Assets::Asset (class) Updated on 2023-01-01
...
struct Engine::Assets::Asset::Event::Waiting waiting; Updated on 2023-01-01
...
int usage; Updated on 2023-01-01
...
bool success; Updated on 2023-01-01
...
friend class AudioManager(AudioManager); friend Audio::doSomething # Defined in header \u0026lt;src/Audio/AudioBuffer.hpp\u0026gt;
friend void Audio::doSomething(AudioBuffer \u0026amp; buffer); Updated on 2023-01-01
...
Type type; Updated on 2023-01-01
...
class Exception; Inherits from std::exception
...
class Handle; Inherited by: Handle is a base class for Texture
...
int handle; Updated on 2023-01-01
...
Basic exception guarantee.
Updated on 2023-01-01
`}),e.add({id:25,href:"/doxybook/hugo-book/namespaces/namespaceengine_1_1gui/",title:"Engine::Gui",section:"Namespaces",content:` Engine::Gui # Classes # Classes Description GuiWidget Some generic gui widget class. (class) Updated on 2023-01-01
...
_Filename: example-1.cpp_ ------------------------------- \u0026lt;sub\u0026gt;Updated on 2023-01-01\u0026lt;/sub\u0026gt; `}),e.add({id:31,href:"/doxybook/hugo-book/examples/",title:"Examples",section:"Doxybook Example",content:` Examples # Example example-1.cpp This is an example. (example) Updated on 2023-01-01
`}),e.add({id:32,href:"/doxybook/hugo-book/files/",title:"Files",section:"Doxybook Example",content:` Files # File src (directory) src/Engine.hpp (file) src/Exception.hpp (file) src/Assets (directory) src/Assets/Asset.hpp (file) src/Assets/Assets.hpp (file) src/Audio (directory) src/Audio/Audio.hpp (file) src/Audio/AudioBuffer.hpp (file) src/Audio/AudioManager.hpp (file) src/Graphics (directory) src/Graphics/Framebuffer.hpp (file) src/Graphics/Graphics.hpp (file) src/Graphics/Handle.hpp (file) src/Graphics/Renderer.hpp (file) src/Graphics/Texture.hpp (file) src/Graphics/Texture2D.hpp (file) src/Graphics/Texture3D.hpp (file) src/Gui (directory) src/Gui/Gui.hpp (file) src/Gui/GuiWidget.hpp (file) src/Utils (directory) src/Utils/ArrayView.hpp (file) src/Utils/Config.hpp (file) src/Utils/Log.hpp (file) src/Utils/Path.hpp (file) src/Utils/Utils.hpp (file) Updated on 2023-01-01
...
Classes # Classes Description Asset Engine::Assets::Asset (class) Event Engine::Assets::Asset::Event (union) Updated on 2023-01-01
...
Classes # Classes Description GuiWidget Some generic gui widget class. (class) Updated on 2023-01-01
...
Classes # Classes Description ArrayView Filesystem path utility functions. (class) Functions # Member Functions Description name_with_underscores (function) Functions # function name_with_underscores # Defined in header \u0026lt;src/Utils/Utils.hpp\u0026gt;
void name_with_underscores(const std::string \u0026amp; arg); Exception Safety
Basic exception guarantee.
Updated on 2023-01-01
`}),e.add({id:41,href:"/doxybook/hugo-book/files/dir_68267d1309a1af8e8297ef4c3efbcdba/",title:"src",section:"Files",content:` src # Directories # Directories Description src/Assets src/Audio src/Graphics src/Gui src/Utils Files # Files Description src/Engine.hpp src/Exception.hpp Updated on 2023-01-01
`}),e.add({id:42,href:"/doxybook/hugo-book/files/dir_e0c1ede47f21c4a643a1257f949f98e0/",title:"src/Assets",section:"Files",content:` src/Assets # Files # Files Description src/Assets/Asset.hpp src/Assets/Assets.hpp Updated on 2023-01-01
`}),e.add({id:43,href:"/doxybook/hugo-book/files/asset_8hpp/",title:"src/Assets/Asset.hpp",section:"Files",content:` src/Assets/Asset.hpp # #include \u0026lt;src/Assets/Asset.hpp\u0026gt; Namespaces # Name Description Engine This namespace contains all of the necessary engine components. Engine::Assets Classes # Classes Description Asset Engine::Assets::Asset (class) Event Engine::Assets::Asset::Event (union) Loaded Engine::Assets::Asset::Event::Loaded (struct) Unloaded Engine::Assets::Asset::Event::Unloaded (struct) Waiting Engine::Assets::Asset::Event::Waiting (struct) Updated on 2023-01-01
`}),e.add({id:44,href:"/doxybook/hugo-book/files/assets_8hpp/",title:"src/Assets/Assets.hpp",section:"Files",content:` src/Assets/Assets.hpp # #include \u0026lt;src/Assets/Assets.hpp\u0026gt; Updated on 2023-01-01
`}),e.add({id:45,href:"/doxybook/hugo-book/files/dir_c64386e93f356b78d4612c7b7741707c/",title:"src/Audio",section:"Files",content:` src/Audio # Files # Files Description src/Audio/Audio.hpp src/Audio/AudioBuffer.hpp src/Audio/AudioManager.hpp Updated on 2023-01-01
`}),e.add({id:46,href:"/doxybook/hugo-book/files/audio_8hpp/",title:"src/Audio/Audio.hpp",section:"Files",content:` src/Audio/Audio.hpp # #include \u0026lt;src/Audio/Audio.hpp\u0026gt; Updated on 2023-01-01
`}),e.add({id:47,href:"/doxybook/hugo-book/files/audiobuffer_8hpp/",title:"src/Audio/AudioBuffer.hpp",section:"Files",content:` src/Audio/AudioBuffer.hpp # #include \u0026lt;src/Audio/AudioBuffer.hpp\u0026gt; Namespaces # Name Description Engine This namespace contains all of the necessary engine components. Engine::Audio Classes # Classes Description AudioBuffer A simple audio buffer to hold PCM samples (class) TypedAudioData Use this to populate the buffer. (struct) Updated on 2023-01-01
...
`}),e.add({id:57,href:"/doxybook/hugo-book/files/texture2d_8hpp/",title:"src/Graphics/Texture2D.hpp",section:"Files",content:` src/Graphics/Texture2D.hpp # #include \u0026lt;src/Graphics/Texture2D.hpp\u0026gt; Namespaces # Name Description Engine This namespace contains all of the necessary engine components. Engine::Graphics Classes # Classes Description Texture2D Engine::Graphics::Texture2D (class) Updated on 2023-01-01
`}),e.add({id:58,href:"/doxybook/hugo-book/files/texture3d_8hpp/",title:"src/Graphics/Texture3D.hpp",section:"Files",content:` src/Graphics/Texture3D.hpp # #include \u0026lt;src/Graphics/Texture3D.hpp\u0026gt; Namespaces # Name Description Engine This namespace contains all of the necessary engine components. Engine::Graphics Classes # Classes Description Texture3D Some deprecated class. (class) Updated on 2023-01-01
`}),e.add({id:59,href:"/doxybook/hugo-book/files/dir_b5ac5e964c12a6b13a9d28feb9f3d3ed/",title:"src/Gui",section:"Files",content:` src/Gui # Files # Files Description src/Gui/Gui.hpp src/Gui/GuiWidget.hpp Updated on 2023-01-01
`}),e.add({id:60,href:"/doxybook/hugo-book/files/gui_8hpp/",title:"src/Gui/Gui.hpp",section:"Files",content:` src/Gui/Gui.hpp # #include \u0026lt;src/Gui/Gui.hpp\u0026gt; Updated on 2023-01-01
`}),e.add({id:61,href:"/doxybook/hugo-book/files/guiwidget_8hpp/",title:"src/Gui/GuiWidget.hpp",section:"Files",content:` src/Gui/GuiWidget.hpp # #include \u0026lt;src/Gui/GuiWidget.hpp\u0026gt; Namespaces # Name Description Engine This namespace contains all of the necessary engine components. Engine::Gui Classes # Classes Description GuiWidget Some generic gui widget class. (class) Updated on 2023-01-01
`}),e.add({id:62,href:"/doxybook/hugo-book/files/dir_a7363e98f9e0bdd87618633653859815/",title:"src/Utils",section:"Files",content:` src/Utils # Files # Files Description src/Utils/ArrayView.hpp src/Utils/Config.hpp src/Utils/Log.hpp src/Utils/Path.hpp src/Utils/Utils.hpp Updated on 2023-01-01
`}),e.add({id:63,href:"/doxybook/hugo-book/files/arrayview_8hpp/",title:"src/Utils/ArrayView.hpp",section:"Files",content:` src/Utils/ArrayView.hpp # #include \u0026lt;src/Utils/ArrayView.hpp\u0026gt; Namespaces # Name Description Engine This namespace contains all of the necessary engine components. Engine::Utils Classes # Classes Description ArrayView Filesystem path utility functions. (class) Updated on 2023-01-01
`}),e.add({id:64,href:"/doxybook/hugo-book/files/config_8hpp/",title:"src/Utils/Config.hpp",section:"Files",content:` src/Utils/Config.hpp # #include \u0026lt;src/Utils/Config.hpp\u0026gt; Updated on 2023-01-01
`}),e.add({id:65,href:"/doxybook/hugo-book/files/log_8hpp/",title:"src/Utils/Log.hpp",section:"Files",content:` src/Utils/Log.hpp # #include \u0026lt;src/Utils/Log.hpp\u0026gt; Updated on 2023-01-01
`}),e.add({id:66,href:"/doxybook/hugo-book/files/path_8hpp/",title:"src/Utils/Path.hpp",section:"Files",content:` src/Utils/Path.hpp # #include \u0026lt;src/Utils/Path.hpp\u0026gt; Namespaces # Name Description Engine This namespace contains all of the necessary engine components. Engine::Utils Engine::Utils::Path Filesystem path utility functions. Updated on 2023-01-01
`}),e.add({id:67,href:"/doxybook/hugo-book/files/utils_8hpp/",title:"src/Utils/Utils.hpp",section:"Files",content:` src/Utils/Utils.hpp # #include \u0026lt;src/Utils/Utils.hpp\u0026gt; Namespaces # Name Description Engine This namespace contains all of the necessary engine components. Engine::Utils Updated on 2023-01-01
`}),e.add({id:68,href:"/doxybook/hugo-book/namespaces/namespacestd/",title:"std",section:"Namespaces",content:` std # Updated on 2023-01-01
`}),e.add({id:69,href:"/doxybook/hugo-book/pages/test/",title:"Test List",section:"Pages",content:` Test List # Class Engine::Audio::AudioBuffer
Some random test description Updated on 2023-01-01
`}),e.add({id:70,href:"/doxybook/hugo-book/pages/todo/",title:"Todo List",section:"Pages",content:` Todo List # Class Engine::Audio::AudioBuffer
Some random todo Updated on 2023-01-01
`})})()