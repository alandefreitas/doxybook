...
Updated on 2022-11-15 at 00:06:21 +0000
...
Don\u0026rsquo;t use this texture type Updated on 2022-11-15 at 00:06:21 +0000
...
Updated on 2022-11-15 at 00:06:21 +0000
`}),e.add({id:8,href:"/doxybook/hugo-book/namespaces/namespaceengine_1_1assets/",title:"Engine::Assets",section:"Namespaces",content:` Engine::Assets # Classes # Name class Engine::Assets::Asset Updated on 2022-11-15 at 00:06:21 +0000
...
Public Attributes # Name bool success int usage Public Attributes Documentation # variable success # bool success; variable usage # int usage; Updated on 2022-11-15 at 00:06:21 +0000
...
Public Attributes # Name bool success Public Attributes Documentation # variable success # bool success; Updated on 2022-11-15 at 00:06:21 +0000
...
#include \u0026lt;AudioBuffer.hpp\u0026gt;
Public Attributes # Name AudioData8U buffer Type type Public Attributes Documentation # variable buffer # AudioData8U buffer; variable type # Type type; Updated on 2022-11-15 at 00:06:21 +0000
...
First item Second item Public Functions Documentation # function AudioManager # AudioManager( int numOfChannels =128 ) function ~AudioManager # ~AudioManager() function enque # void enque( const AudioBuffer \u0026amp; buffer ) Updated on 2022-11-15 at 00:06:21 +0000
...
Protected Attributes Documentation # variable loaded # bool loaded {false}; variable type # Type type; Updated on 2022-11-15 at 00:06:21 +0000
...
Reimplements: Engine::Graphics::Texture::getDepth
Updated on 2022-11-15 at 00:06:21 +0000
`}),e.add({id:25,href:"/doxybook/hugo-book/namespaces/namespaceengine_1_1gui/",title:"Engine::Gui",section:"Namespaces",content:` Engine::Gui # Classes # Name class Engine::Gui::GuiWidget Some generic gui widget class. Updated on 2022-11-15 at 00:06:21 +0000
...
Template Parameters:
T The type of the data, for example uint8_t Public Functions Documentation # function ArrayView # ArrayView( const T * src, size_t len ) function ~ArrayView # virtual ~ArrayView() =default function data # virtual const T * data() const function size # virtual size_t size() const Updated on 2022-11-15 at 00:06:21 +0000
...
_Filename: example-1.cpp_ ------------------------------- Updated on 2022-11-15 at 00:06:21 +0000 `}),e.add({id:31,href:"/doxybook/hugo-book/examples/",title:"Examples",section:"Doxybook Example",content:` Examples # example example-1.cpp This is an example. Updated on 2022-11-15 at 00:06:21 +0000
...
`}),e.add({id:38,href:"/doxybook/hugo-book/pages/",title:"Pages",section:"Doxybook Example",content:` Pages # page Advanced Usage page Bug List page Deprecated List page Doxybook Example page Introduction page Test List page Todo List Updated on 2022-11-15 at 00:06:21 +0000
...
define LOG_DEBUG # #define LOG_DEBUG( MSG, ... ) printf(MSG, ##__VA_ARGS__) Updated on 2022-11-15 at 00:06:21 +0000
`}),e.add({id:41,href:"/doxybook/hugo-book/files/dir_68267d1309a1af8e8297ef4c3efbcdba/",title:"src",section:"Files",content:` src # Directories # Name src/Assets src/Audio src/Graphics src/Gui src/Utils Files # Name src/Engine.hpp src/Exception.hpp Updated on 2022-11-15 at 00:06:21 +0000
`}),e.add({id:42,href:"/doxybook/hugo-book/files/dir_e0c1ede47f21c4a643a1257f949f98e0/",title:"src/Assets",section:"Files",content:` src/Assets # Files # Name src/Assets/Asset.hpp src/Assets/Assets.hpp Updated on 2022-11-15 at 00:06:21 +0000
...
`}),e.add({id:44,href:"/doxybook/hugo-book/files/assets_8hpp/",title:"src/Assets/Assets.hpp",section:"Files",content:` src/Assets/Assets.hpp # Source code # #pragma once #include \u0026#34;AssetModel.hpp\u0026#34; #include \u0026#34;AssetManager.hpp\u0026#34; Updated on 2022-11-15 at 00:06:21 +0000
`}),e.add({id:45,href:"/doxybook/hugo-book/files/dir_c64386e93f356b78d4612c7b7741707c/",title:"src/Audio",section:"Files",content:` src/Audio # Files # Name src/Audio/Audio.hpp src/Audio/AudioBuffer.hpp src/Audio/AudioManager.hpp Updated on 2022-11-15 at 00:06:21 +0000
`}),e.add({id:46,href:"/doxybook/hugo-book/files/audio_8hpp/",title:"src/Audio/Audio.hpp",section:"Files",content:` src/Audio/Audio.hpp # Source code # #pragma once #include \u0026#34;AudioBuffer.hpp\u0026#34; #include \u0026#34;AudioManager.hpp\u0026#34; Updated on 2022-11-15 at 00:06:21 +0000
...
Source code # #include \u0026#34;Assets/Assets.hpp\u0026#34; #include \u0026#34;Audio/Audio.hpp\u0026#34; #include \u0026#34;Exception.hpp\u0026#34; #include \u0026#34;Graphics/Graphics.hpp\u0026#34; #include \u0026#34;Gui/Gui.hpp\u0026#34; #include \u0026#34;Utils/Utils.hpp\u0026#34; extern std::string someGlobalFunc(); namespace Engine { extern std::string getVersion(); } // namespace Engine //----------------------------------------------------------- //----------------------------------------------------------- Updated on 2022-11-15 at 00:06:21 +0000
...
`}),e.add({id:55,href:"/doxybook/hugo-book/files/renderer_8hpp/",title:"src/Graphics/Renderer.hpp",section:"Files",content:` src/Graphics/Renderer.hpp # Source code # #pragma once Updated on 2022-11-15 at 00:06:21 +0000
...
`}),e.add({id:59,href:"/doxybook/hugo-book/files/dir_b5ac5e964c12a6b13a9d28feb9f3d3ed/",title:"src/Gui",section:"Files",content:` src/Gui # Files # Name src/Gui/Gui.hpp src/Gui/GuiWidget.hpp Updated on 2022-11-15 at 00:06:21 +0000
`}),e.add({id:60,href:"/doxybook/hugo-book/files/gui_8hpp/",title:"src/Gui/Gui.hpp",section:"Files",content:` src/Gui/Gui.hpp # Source code # #pragma once Updated on 2022-11-15 at 00:06:21 +0000
...
`}),e.add({id:62,href:"/doxybook/hugo-book/files/dir_a7363e98f9e0bdd87618633653859815/",title:"src/Utils",section:"Files",content:` src/Utils # Files # Name src/Utils/ArrayView.hpp src/Utils/Config.hpp src/Utils/Log.hpp src/Utils/Path.hpp src/Utils/Utils.hpp Updated on 2022-11-15 at 00:06:21 +0000
...
define ENGINE_ARCH # #define ENGINE_ARCH \u0026#34;amd64\u0026#34; Source code # #pragma once #define ENGINE_VERSION \u0026#34;v1.0.1\u0026#34; #define ENGINE_ARCH \u0026#34;amd64\u0026#34; Updated on 2022-11-15 at 00:06:21 +0000
...
Some random test description Updated on 2022-11-15 at 00:06:21 +0000
...
Some random todo Updated on 2022-11-15 at 00:06:21 +0000
`})})()